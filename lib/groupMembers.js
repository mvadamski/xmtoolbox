...
async function getManyRecipients(env, groupId) {
  return common.getMany(env, `/api/xm/1/groups/${groupId}/recipients`, '', 'Group Recipients');
}
...
exports.getManyRecipients = getManyRecipients;
