...
async function getAll(env) {
  return common.getMany(env, `/api/xm/1/scenarios`, '', 'Scenarios');
}
...
function getSenderPermissions(env, scenarioId) {
  return common.get(env, `/api/xm/1/scenarios/${scenarioId}/sender-permissions`, '');
}
