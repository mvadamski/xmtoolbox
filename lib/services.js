...
async function getManyServiceDependencies(env, query) {
  return common.getMany(env, '/api/xm/1/service-dependencies', query, 'Services');
}
...
async function createServiceDependency(env, service) {
  return common.create(env, '/api/xm/1/service-dependencies', service, 'Service', true);
}
...
async function createServiceDependency(env, service) {
  return common.create(env, '/api/xm/1/service-dependencies/', service, 'Service');
}
...
async function _deleteServiceDependency(env, serviceId) {
  return common.delete(env, '/api/xm/1/service-dependencies/', serviceId, 'Service Dependency');
}
...
exports.createServiceDependency    = createServiceDependency;
exports.deleteServiceDependency    = _deleteServiceDependency;
exports.getManyServiceDependencies = getManyServiceDependencies;
