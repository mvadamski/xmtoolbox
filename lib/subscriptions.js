...
async function addSubscriber(env, subscriber, subscriptionId) {
  // console.log({subscriptionId, subscriber});
  return common.updatePUT(env, `/api/xm/1/subscriptions/${subscriptionId}/subscribers`, subscriber, subscriptionId, 'Add Subscriber');
}
